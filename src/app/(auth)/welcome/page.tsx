...
const Page = () => {
  ...
  return <div className="flex flex-1 w-full justify-center items-center px-4">
    <BackgroundPattern className="absolute inset-0 left-1/2 z-0 -translate-x-1/2" />

    <div className="relative z-10 flex -translate-y-1/2 flex-col items-center text-center gap-6">
